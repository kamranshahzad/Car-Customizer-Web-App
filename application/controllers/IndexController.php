...
class IndexController extends Zend_Controller_Action{
    ...
    public function indexAction() {
        ...
        $pageContent = $varMap->findByKey('indexpage');
        ...
        if ($this->getRequest()->isPost()) {
            ...
            $this->view->pageContent = $pageContent->getVarValue();
            $this->view->form = $loginForm;
        }
		$this->view->pageContent = $pageContent->getVarValue();
        $this->view->form = $loginForm;
    ...
    public function aboutusAction(){
        ...
        $loginForm = new Application_Form_IndexLoginFrm();
        $varMap = new Application_Model_Mapper_VariableMapper();
        $pageContent = $varMap->findByKey('aboutpage');
    ...
    public function contactusAction(){
        ...
        $loginForm = new Application_Form_IndexLoginFrm();
        $varMap = new Application_Model_Mapper_VariableMapper();
        $pageContent = $varMap->findByKey('contactpage');
