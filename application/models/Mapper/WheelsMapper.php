...
class Application_Model_Mapper_WheelsMapper
{
	protected $_dbTable;
	...
	public function getDbTable(){
		if(null === $this->_dbTable){
			$this->setDbTable('Application_Model_DbTable_WheelsDb');
		}
		return $this->_dbTable;
	}
	
	public function save(Application_Model_Wheels $part){
		$data	=	array(
	...
	public function findById($id){
		...
		//$row = $result->current();
		$part	=	new Application_Model_Wheels();
